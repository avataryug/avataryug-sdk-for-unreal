...
#include "EconomyModel.h"
#include "EconomyRequest.h"
#include "EconomyHandler.generated.h"

/**
 *
 */
UCLASS()
class AVATARYUG_API UEconomyHandler : public UBlueprintFunctionLibrary
{
	GENERATED_BODY()
public:
	...
	static void GetStoreItemsByID(FString itemID, TFunction<void(FGetStoreItemsByIDResult &)> result, TFunction<void(FApiException &)> error);
	UFUNCTION(BlueprintCallable)
